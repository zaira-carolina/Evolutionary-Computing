...
#SBATCH --output=resultado_intento5.log
...
mpirun.openmpi -np ${SLURM_NTASKS} /home/est_posgrado_zaira.martinez/tarea2-paralelo2/src/main 200 cx 19800 20 N-be75np_1000 "resultado_53_20.txt"
